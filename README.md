...
      - [data.htm](#datahtm)  
      - [index.htm](#indexhtm)  
  2.3 [Файли збірки](#23-Файли-збірки)  
...
Цей файл _**public_html/projects/_list.htm**_ збирає всі проекти на головній сторінці

Робимо дублікат першого такого рядка:
```
<!--#include virtual="/projects/zatecky-gus/data.htm"-->                        <!--#include virtual="/_inc/card.htm"-->
```
і правимо під новий проект:
```
<!--#include virtual="/projects/llama-in-the-moon-kingdom/data.htm"-->          <!--#include virtual="/_inc/card.htm"-->
```

### _select.htm

Цей файл _**public_html/projects/_select.htm**_ збирає проекти для вказаного скіла

Робимо дублікат першого такого рядка:
```
<!--#include virtual="/projects/zatecky-gus/data.htm"-->                        <!--#if expr='v("SELSKILL")==v("SKILL") || ... -->
```
і правимо під новий проект:
```
<!--#include virtual="/projects/llama-in-the-moon-kingdom/data.htm"-->          <!--#if expr='v("SELSKILL")==v("SKILL") || ... -->
```
