...
1 [Структура сайту](#Структура-сайту)  
2 [Як створити новий проект](#Як-створити-новий-проект)  
  2.1 [Вибір назви проекту](#Вибір-назви-проекту)  
  2.2 [Файли проекту](#Файли-проекту)  
    2.2.1 [Зображення (.jpg)](#Зображення-jpg)  
    2.2.2 [Код (.htm)](#Код-htm)  
      2.2.2.1 [data.htm](#datahtm)  
      2.2.2.2 [index.htm](#indexhtm)  
3 [Як додати нову навичку (skill)](#Як-додати-нову-навичку-skill)  
4 [Сторінка About](#Сторінка-About)  
